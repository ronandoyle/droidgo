...
//	public void recordStuff(Socket socket)
//	{
//		ParcelFileDescriptor parcelfd = ParcelFileDescriptor.fromSocket(socket);
//		
//		recorder.setAudioSource(MediaRecorder.AudioSource.MIC);
//		recorder.setOutputFormat(MediaRecorder.OutputFormat.MPEG_4);
//		recorder.setAudioEncoder(MediaRecorder.AudioEncoder.AMR_NB); //192.168.1.4:8080
...
//				MediaRecorder rec = LocalHttpService.getRecording();
//				AudioRecord aRec = new AudioRecord(rec, rec.getSampleRate(), rec.getChannelConfiguration(), rec.getAudioFormat(), rec.getMinBufferSize(rec.getSampleRate(), rec.getChannelConfiguration(), rec.getAudioFormat()));
